...
- Si las credenciales son correctas (en este caso valdrá con hardcodearlas) se mostrará solo un texto "Acceso correcto" y el título de la TopBar será el nombre de usuario. Además, se mostrará en la TopBar un borón de "Log out".
